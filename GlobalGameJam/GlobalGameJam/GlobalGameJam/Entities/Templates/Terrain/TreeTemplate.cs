...
namespace GlobalGameJam.Entities.Templates.Terrain
{
    class TreeTemplate : IEntityTemplate
    {
        ...
        public Entity BuildEntity(Entity e, params object[] args)
        {
            ...
            Sprite sex = e.AddComponent<Sprite>(new Sprite(ScreenHelper.SpriteSheet, "tree"));
            ...
            FixtureFactory.AttachCircle(ConvertUnits.ToSimUnits((sex.Source[0].Height + sex.Source[0].Width) / 4), 
                1f, bitch);
